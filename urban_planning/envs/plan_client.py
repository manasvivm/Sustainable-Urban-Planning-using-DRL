...
class PlanClient(object):
    ...
    def get_wastemgmt_reward(self) -> float:
        ...
        if distance_to_residential < min_residential_distance_threshold:
            residential_penalty = -1.0 * (min_residential_distance_threshold - distance_to_residential) / min_residential_distance_threshold
        ...
        final_reward = green_space_reward * 0.3 + residential_penalty * 0.7
